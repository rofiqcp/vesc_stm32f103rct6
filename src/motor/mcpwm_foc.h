...
// Parameter start_cycle: cycle CPU yang ditangkap pada awal IRQ DMA sebelum pemeriksaan flag.
// Fungsi mcpwm_foc_adc_words_isr_timed: menjalankan FOC dengan timestamp IRQ asli agar budget 4000 cycle terukur end-to-end.
...
static inline void foc_adc_dma_isr_timed(const volatile uint32_t adc_words[6], uint32_t start_cycle) {
...
static inline void foc_adc_dma_isr(const volatile uint32_t adc_words[6]) {
